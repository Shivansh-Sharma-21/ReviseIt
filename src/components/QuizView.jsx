                                    ...
                                    {currentQuestion.options.map((option, idx) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`p-4 md:p-6 rounded-2xl md:rounded-3xl border-2 text-left transition-all duration-300 group relative flex items-center gap-4 md:gap-5 ${styleClasses} ${hasAnswered && !isSelected && !isCorrect ? 'opacity-50' : ''}`}
                                            >
                        ...
                        <div className="flex items-center gap-2 md:gap-3 order-1 sm:order-2">
                            <div className="flex items-center gap-2 flex-grow sm:flex-none">
                                <button 
                                    ...
                                    className="w-12 h-12 rounded-xl md:rounded-2xl border-2 border-slate-200 dark:border-slate-800 text-slate-300 disabled:opacity-30 hover:border-indigo-500 transition-all flex items-center justify-center"
                                >
                                    <ChevronLeft size={24} />
                                </button>
                                <button 
